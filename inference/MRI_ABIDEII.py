...
def get_args():
    ...
    parser.add_argument(
        "--output-dir",
        default="/project/amgrp/txu/flare2025/inference_out/ABIDEII",
        type=str,
    ...
    parser.add_argument(
        ...
        default='/project/amgrp/txu/flare2025/MRI_ABIDEII.json'
    )
    parser.add_argument(
        "--decoder-weights",
        type=str,
        help="Path to decoder weights for segmentation head",
        default='/project/amgrp/txu/flare2025/outputs/it50k_MRI_ABIDEII/best_model.pth'
    )
