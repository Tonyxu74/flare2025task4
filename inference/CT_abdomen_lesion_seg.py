...
def get_args():
    ...
    parser.add_argument(
        "--output-dir",
        default="/project/amgrp/txu/flare2025/inference_out/abdomen_lesion_seg",
        type=str,
    ...
    parser.add_argument(
        ...
        default='/project/amgrp/txu/flare2025/CT_abdomen_lesion_seg.json'
    )
    parser.add_argument(
        "--decoder-weights",
        type=str,
        help="Path to decoder weights for segmentation head",
        default='/project/amgrp/txu/flare2025/outputs/it50k_CT_abdomen_lesion_seg_highres_adapter/best_model.pth'
    )
...
val_transforms = Compose([
    EnsureType(),
    Spacing(pixdim=(1.2, 1.2, 1.5), mode="bilinear"),
...
seg_model = ViTAdapterUNETRHead(feature_model, 1, 96, num_classes, autocast_ctx)
seg_model.train()
