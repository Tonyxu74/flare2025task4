...
def get_args():
    ...
    parser.add_argument(
        "--output-dir",
        default="/project/amgrp/txu/flare2025/inference_out/MRI_abdomen_organ_seg",
        type=str,
    ...
    parser.add_argument(
        ...
        default='/project/amgrp/txu/flare2025/MRI_abdomen_seg.json'
    )
    parser.add_argument(
        "--decoder-weights",
        type=str,
        help="Path to decoder weights for segmentation head",
        default='/project/amgrp/txu/flare2025/outputs/it125k_MRI_abdomen_seg_lr3e-4/best_model.pth'
    )
...
val_transforms = Compose([
    EnsureType(),
    Spacing(pixdim=(1.25, 1.25, 1.25), mode="bilinear"),
