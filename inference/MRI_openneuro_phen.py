...
def get_args():
    ...
    parser.add_argument(
        "--output-dir",
        default="/project/amgrp/txu/flare2025/inference_out/openneuro_NeuropsychiatricPhenomics",
        type=str,
    ...
    parser.add_argument(
        ...
        default='/project/amgrp/txu/flare2025/MRI_openneuro_phen.json'
    )
    parser.add_argument(
        "--decoder-weights",
        type=str,
        help="Path to decoder weights for segmentation head",
        default='/project/amgrp/txu/flare2025/outputs/it50k_MRI_openneuro_phen/best_model.pth'
    )
...
val_transforms = Compose([
    ...
    Resize(spatial_size=(int(image_size * 1.25), int(image_size * 1.25), int(image_size * 1.25 * 0.6875)), mode="trilinear"),
