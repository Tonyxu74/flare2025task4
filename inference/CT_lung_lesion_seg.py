...
def get_args():
    ...
    parser.add_argument(
        "--output-dir",
        default="/project/amgrp/txu/flare2025/inference_out/lung_lesion_seg",
        type=str,
    ...
    parser.add_argument(
        ...
        default='/project/amgrp/txu/flare2025/CT_lung_lesion_seg.json'
    )
    parser.add_argument(
        "--decoder-weights",
        type=str,
        help="Path to decoder weights for segmentation head",
        default='/project/amgrp/txu/flare2025/outputs/it50k_CT_lung_lesion_seg/best_model.pth'
    )
