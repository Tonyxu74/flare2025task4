...
from dinov2.layers import Mlp, PatchEmbed, PatchEmbed3d, SwiGLUFFNFused, MemEffAttention, LoRAMemEffAttention, NestedTensorBlock as Block
...
def vit_large_3d_lora(patch_size=16, **kwargs):
    model = DinoVisionTransformer3d(
        patch_size=patch_size,
        embed_dim=1024,
        depth=24,
        num_heads=16,
        mlp_ratio=4,
        block_fn=partial(Block, attn_class=LoRAMemEffAttention),
        **kwargs,
    )
    return model